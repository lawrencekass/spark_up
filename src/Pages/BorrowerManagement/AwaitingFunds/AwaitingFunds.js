...
function AwaitingFunds(props) {
  ...
  const columns = [
    ...
    { title: "Amount requested", field: "amountrequesting" },
    { title: "Location", field: "location" },
    { title: "Loan Published", field: "loanpublished" },
    { title: "No of days awaiting loan", field: "noofdays" },
